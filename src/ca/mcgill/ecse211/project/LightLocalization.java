...
public class LightLocalization {
  ...
  public static void localize3() {
    ...
    //--------------------------------------------------------------------------------------------------------------------------------------------    
    if ((LightLocalization.get_value_of_colour1() <= line_threshold_L) && (LightLocalization.get_value_of_colour2() <= line_threshold_R)) {       //both light sensors on line already
      return;
    }

    else if (!(LightLocalization.get_value_of_colour1() <= line_threshold_L) && (LightLocalization.get_value_of_colour2() <= line_threshold_R)) {  //right sensor on line already
      while(!(LightLocalization.get_value_of_colour1() <= line_threshold_L)) { //while the left sensor does not detect a line
    ...
    else if ((LightLocalization.get_value_of_colour1() <= line_threshold_L) && !(LightLocalization.get_value_of_colour2() <= line_threshold_R)) {    //left sensor on line already
      while(!(LightLocalization.get_value_of_colour2() <= line_threshold_R)) { //while the right sensor does not detect a line
    ...
    //--------------------------------------------------------------------------------------------------------------------------------------------    
      ...
      while (!(LightLocalization.get_value_of_colour1() <= line_threshold_L) && !(LightLocalization.get_value_of_colour2() <= line_threshold_R)) { //while neither sensor on line
        leftMotor.setSpeed(50);
        rightMotor.setSpeed(50);
        leftMotor.forward();
        rightMotor.forward();
       ...
       */
      if((LightLocalization.get_value_of_colour1() <= line_threshold_L) && (LightLocalization.get_value_of_colour2() <= line_threshold_R)) {  //both sensors detect a line
        leftMotor.stop(true);
       ...
       */
      else  if (!(LightLocalization.get_value_of_colour1() <= line_threshold_L) && (LightLocalization.get_value_of_colour2() <= line_threshold_R)) {      //right sensor detects line
        rightMotor.stop(false); //stop the right motor as the right sensor has detected a line
        while(!(LightLocalization.get_value_of_colour1() <= line_threshold_R)) { //while the left sensor does not detect a line
       ...
       */
      else  if ((LightLocalization.get_value_of_colour1() <= line_threshold_L) && !(LightLocalization.get_value_of_colour2() <= line_threshold_R)) {      //left sensor detects line
