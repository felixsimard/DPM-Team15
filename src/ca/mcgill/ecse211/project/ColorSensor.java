...
public class ColorSensor extends Thread {
   ...
   * 
   * 
   * @param currentRGB an array containing the current RGB values read by the light/color sensor.
   * @param location   a string representing the location in which the experiment/dem is being carried out in order to adjust the ideal RGB values.
   */
